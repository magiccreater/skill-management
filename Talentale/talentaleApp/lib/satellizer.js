...
(function(window, angular, undefined) {
  ...
  angular.module('satellizer', [])
    ...
    .factory('satellizer.Oauth2', [
      ...
      'satellizer.config',
      'satellizer.storage',
      function($q, $http, $window,$injector, popup, utils, config, storage) {
          return function() {
              ...
              oauth2.exchangeForToken = function(oauthData, userData) {
                  ...
                  var talentaleAPI = $injector.get('talentaleAPI');
                  return $http({ method: 'POST', url: talentaleAPI.base_url + defaults.url, data: data });
              };
